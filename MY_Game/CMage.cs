        ...
        public void ChangeStatsWithArena(string battleGround)
        {
            switch (battleGround.ToLower())
            {
                case "vulcan":
                    VulcanStats();
                    print.BuffsDebuffs();
                    Console.WriteLine($"\t  {Name}'s dodge chance reduced by 10 units", print.Red());
                    Console.WriteLine($"\t  {Name}'s physical resistance increases by 15 units\n", print.Green());
                    break;

                case "field":
                    FieldStats();
                    print.BuffsDebuffs();
                    Console.WriteLine($"\t  {Name}'s critical chance increases by 10 units", print.Green());
                    Console.WriteLine($"\t  {Name}'s dodge chance reduced by 10 units\n", print.Red());
                    break;

                case "subway":
                    SubwayStats();
                    print.BuffsDebuffs();
                    Console.WriteLine($"\t  {Name}'s dodge chance reduced by 20 units", print.Red());
